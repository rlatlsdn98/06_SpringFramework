package com.ohgiraffers.common.section03.componentscan.subsection01.java;

import com.ohgiraffers.common.MemberDAO;
import com.ohgiraffers.common.section02.javaconfig.Applicaiton;
...
public class Application {
  public static void main(String[] args) {
    ...
    // 등록된 bean들의 이름을 가져옴  String[] ==> 이름이니까 이걸로 가져옴

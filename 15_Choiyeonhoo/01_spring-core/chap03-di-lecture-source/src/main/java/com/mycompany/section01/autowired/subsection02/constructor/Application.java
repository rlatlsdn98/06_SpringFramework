package com.mycompany.section01.autowired.subsection02.constructor;
...
public class Application {
  public static void main(String[] args) {
    ...
    ApplicationContext context = new AnnotationConfigApplicationContext("com.mycompany.section01");

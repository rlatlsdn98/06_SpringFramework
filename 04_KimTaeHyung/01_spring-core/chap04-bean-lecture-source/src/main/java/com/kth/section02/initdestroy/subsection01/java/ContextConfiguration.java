package com.kth.section02.initdestroy.subsection01.java;

import com.kth.common.Beverage;
import com.kth.common.Bread;
import com.kth.common.Product;
import com.kth.common.ShoppingCart;
...
public class ContextConfiguration {
  ...
  public Product water() {
	...
	/* init-method로 openShop 메소드를 설정하고 destroy-method로 closeShop 메소드를 설정한다. */
